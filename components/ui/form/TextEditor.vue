                ...
                <div class="px-3 py-2 border-b border-gray-200 dark:border-gray-600">
                    <div class="flex flex-wrap items-center">
                        <div class="flex items-center space-x-1 rtl:space-x-reverse flex-wrap">
                            <div @click="editor.chain().focus().toggleHeading({level: 1}).run()"
                            ...
                            <div @click="editor.chain().focus().toggleHeading({level: 2}).run()"
                            ...
                            <div @click="editor.chain().focus().toggleHeading({level: 3}).run()"
                            ...
                            <div @click="editor.chain().focus().underline().run()"
                            ...
                            <div @click="editor.chain().focus().strike().run()"
