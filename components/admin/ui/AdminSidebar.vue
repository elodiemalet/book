<template>
    <div class="h-full">
        <TransitionRoot as="template" :show="sidebarOpen">
            <DialogComponent class="relative z-50 lg:hidden" @close="sidebarOpen = false">
                <TransitionChild
                                ...
                                <nav class="flex flex-1 flex-col">
                                    <ul role="list" class="flex flex-1 flex-col gap-y-7">
                                        ...
                                        <li class="mt-auto">
                                            <a
                                                href="#"
                                                class="group -mx-2 flex gap-x-3 rounded-md p-2 font-semibold text-indigo-200 hover:bg-indigo-700 hover:text-white">
                                                <Cog6ToothIcon
        ...
        <div class="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
            ...
            <div class="flex grow flex-col gap-y-5 overflow-y-auto bg-indigo-600 px-6 pb-4">
                <div class="flex h-16 shrink-0 items-center">
                    <img
                        class="h-8 w-auto" src="https://tailwindcss.com/plus-assets/img/logos/mark.svg?color=white"
                        alt="Your Company">
                </div>
                <nav class="flex flex-1 flex-col">
                    <ul role="list" class="flex flex-1 flex-col gap-y-7">
            ...
            <div
                ...
                <div class="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
                    <form class="grid flex-1 grid-cols-1" action="#" method="GET">
                        <input
                            type="search" name="search" aria-label="Search"
                    ...
                    <div class="flex items-center gap-x-4 lg:gap-x-6">
                        ...
                        <!-- Profile dropdown -->
                        <AdminMenu as="div" class="relative">
                            ...
                            <Transition
                                ...
                                <MenuItems
                                    ...
                                    <MenuItem>
                                        <p
                                            class="block px-3 py-1  text-gray-900 cursor-pointer"
                                            @click="userLogout">
                                            Se déconnecter
                                        </p>
                                    </MenuItem>
...
export default {
    ...
    methods: {
        userLogout() {
            const {fetch: logout} = useUserSession();
            logout();
            navigateTo('/');
        }
    },
