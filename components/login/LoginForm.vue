<template>
    <div class="flex min-h-full h-screen flex-1">
        <div class="flex flex-1 flex-col justify-center px-4 py-12 sm:px-6 lg:flex-none lg:px-20 xl:px-24 w-[45%]">
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <div class="mt-2">
                                    <input
                                        id="email"
                                        :value="credentials.email" type="email" name="email" autocomplete="email"
                            ...
                            <div>
                                ...
                                <div class="mt-2">
                                    <input
                                        id="password"
                                        :value="credentials.password" type="password" name="password"
